...
/**
 * 周期性属性效果应用器 — 消费需要每 tick 推动的 yizmodqzk 属性。
 *
...
public final class AttributeEffectTicker {
    ...
    private static void applyLifeRegen(LivingEntity entity) {
        AttributeInstance rateInst = entity.getAttribute(YizAttributes.LIFE_REGEN_RATE);
        AttributeInstance pctInst = entity.getAttribute(YizAttributes.LIFE_REGEN_PCT);
